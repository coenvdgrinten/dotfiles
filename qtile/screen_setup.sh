...
xrandr --output eDP-1 --off --output HDMI-1 --off --output DP-1 --off --output DP-2 --off --output DP-3 --off --output DP-4 --off --output DP-3-5 --mode 1920x1080 --pos 1920x0 --rotate normal --output DP-3-6 --mode 1920x1080 --pos 0x0 --rotate normal
else
